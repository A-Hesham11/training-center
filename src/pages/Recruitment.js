    ...
    <main className="relative">
      ...
      <div className="container mb-20">
        <div>
          ...
          <p className="list_style text-mainBlack text-lg">{t("Are you passionate about revolutionizing education and empowering individuals to achieve their full potential? We're on a mission to build a world-class team that shares our commitment to innovation, learning, and positive impact. Explore exciting opportunities to join us in shaping the future of online education.")}</p>
        </div>
